...
export const mockControls: Control[] = [
  {
    ...
    description: 'La politique de sécurité de l\'information et les politiques par thème doivent être définies, approuvées par la direction, publiées, communiquées et reconnues par le personnel concerné et les parties intéressées pertinentes.',
    description_en: 'Information security policy and topic-specific policies shall be defined, approved by management, published, communicated to and acknowledged by relevant personnel and relevant interested parties.',
  ...
  },
  {
    ...
    description_en: 'Information security roles and responsibilities shall be defined and allocated according to the organization needs.',
    control_types: ['preventive'],
    security_properties: ['confidentiality', 'integrity', 'availability'],
  ...
  },
  {
    ...
    name_en: 'Screening',
    description: 'Des vérifications des antécédents de tous les candidats à l\'emploi doivent être effectuées avant leur intégration.',
    description_en: 'Background verification checks on all candidates for employment shall be carried out prior to joining the organization.',
    control_types: ['preventive'],
  ...
  },
  {
    ...
    description_en: 'Security perimeters shall be defined and used to protect areas that contain information and other associated assets.',
    control_types: ['preventive'],
    security_properties: ['confidentiality', 'integrity', 'availability'],
    cybersecurity_concepts: ['protect'],
  ...
  },
  {
    ...
    description: 'Les informations stockées sur, traitées par ou accessibles via les terminaux utilisateurs doivent être protégées.',
    description_en: 'Information stored on, processed by or accessible via user endpoint devices shall be protected.',
    control_types: ['preventive'],
    security_properties: ['confidentiality', 'integrity', 'availability'],
    cybersecurity_concepts: ['protect'],
...
export const mockRisks: Risk[] = [
  {
    ...
    description: 'Risque d\'accès non autorisé aux données personnelles des clients via exploitation de vulnérabilités applicatives',
  ...
  },
  {
    ...
    description: 'Risque d\'indisponibilité prolongée de la plateforme suite à une panne infrastructure',
    ...
    existing_controls_description: 'Infrastructure redondante AWS, sauvegardes quotidiennes, PRA testé',
...
export const mockAudits: InternalAudit[] = [
  {
    ...
    status: 'completed',
    conclusion: 'minor_nc',
    executive_summary: 'Audit satisfaisant avec 2 non-conformités mineures identifiées relatives à la revue des droits d\'accès.',
...
export const mockFindings: AuditFinding[] = [
  {
    ...
    description: 'La revue des droits d\'accès privilégiés n\'a pas été effectuée au T4 2023 comme requis par la procédure PRO-ACC-002.',
...
export const mockPolicies: SecurityPolicy[] = [
  {
    ...
    content_summary: 'Définit les principes, objectifs et responsabilités en matière de sécurité de l\'information.',
    owner: 'user-001',
    status: 'published',
  ...
  },
  {
    ...
    linked_controls: ['c5150000-0000-0000-0000-000000000015', 'c5160000-0000-0000-0000-000000000016'],
...
export const mockDashboard: ISO27001Dashboard = {
  soa_stats: {
    ...
    by_category: [
      { category_code: 'A.5', category_name: 'Organisationnels', total: 37, applicable: 35, implemented: 30, percentage: 86 },
      { category_code: 'A.6', category_name: 'Personnes', total: 8, applicable: 8, implemented: 7, percentage: 88 },
      { category_code: 'A.7', category_name: 'Physiques', total: 14, applicable: 12, implemented: 10, percentage: 83 },
      { category_code: 'A.8', category_name: 'Technologiques', total: 34, applicable: 32, implemented: 25, percentage: 78 },
    ],
  },
  risk_stats: {
    total_risks: 24,
