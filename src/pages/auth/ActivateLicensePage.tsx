    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-900 via-primary-800 to-primary-900 flex items-center justify-center p-6">
      <div className="max-w-lg w-full">
        ...
        <div className="text-center mb-8">
          <div className="w-20 h-20 bg-gradient-to-br from-primary-900 to-primary-900 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-primary-500/30">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="p-8">
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-4 border-2 rounded-xl font-mono text-lg tracking-wider focus:outline-none transition-colors ${
                      error
              ...
              <div className="mt-6 p-4 bg-primary-50 rounded-xl">
                <div className="flex items-start gap-3">
                  <Shield className="text-primary-900 flex-shrink-0 mt-0.5" size={20} />
                  <div>
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1 text-sm font-medium text-primary-900 hover:text-primary-800 mt-2"
                    >
                      sales@advist.com
                    </a>
                  </div>
          ...
          {step === 'validating' && (
            <div className="p-12 text-center">
              ...
              <p className="text-primary-600">{t('auth.activateLicense.validating')}</p>
            </div>
          )}
          ...
          {step === 'preview' && validatedLicense && (
            <div className="p-8">
              ...
              <div className="bg-primary-50 rounded-xl p-6 mb-6 space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-primary-500 flex items-center gap-2">
                    <Star size={16} />
                    {t('auth.activateLicense.plan')}
                  </span>
                  <span className="font-semibold text-primary-900">Enterprise</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-primary-500 flex items-center gap-2">
                    <Users size={16} />
              ...
              <div className="bg-primary-50 rounded-xl p-4 mb-6">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-1.5 text-sm text-primary-800">
                      <Zap size={12} className="text-primary-900" />
                      {feature}
                    </div>
                  ))}
                </div>
          ...
          {step === 'activating' && (
            <div className="p-12 text-center">
              <Loader2 className="w-12 h-12 text-primary-900 animate-spin mx-auto mb-4" />
              <p className="text-primary-600">{t('auth.activateLicense.activating')}</p>
            </div>
          )}
        ...
        <div className="mt-6 text-center">
          <Link to="/" className="text-primary-400 hover:text-white text-sm">
