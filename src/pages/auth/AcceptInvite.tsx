 ...
 * 5. Redirige vers /dashboard (Advist) avec session active
 */
...
export default function AcceptInvite() {
  ...
  useEffect(() => {
    ...
    // Timeout : pas de session après 6s
    const t = setTimeout(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Mark invitation as accepted (best-effort, non-bloquant)
      const {
        data: { user },
      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-gray-50">
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md text-center">
          ...
          <button
            ...
            className="inline-block px-6 py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold transition-colors"
          >
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-indigo-50 to-purple-50">
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          <h1 className="text-2xl font-bold text-indigo-900">Advist</h1>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-7">
          <div className="flex items-start gap-3 p-3 mb-5 rounded-lg bg-green-50 border border-green-200">
            ...
            <div className="text-xs text-gray-700 leading-relaxed">
              ...
              <p>
                Pour finaliser votre compte <span className="font-medium">{userEmail}</span>,
                choisissez un mot de passe sécurisé ci-dessous.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2.5 pr-10 rounded-lg border border-gray-300 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none text-sm"
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2.5 rounded-lg border border-gray-300 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none text-sm"
          ...
          <p className="text-[10px] text-gray-400 text-center mt-5 leading-relaxed">
            Utilisez au moins 12 caractères avec majuscules, chiffres et symboles. Atlas Studio ne
            voit jamais votre mot de passe (bcrypt local).
          </p>
        </div>
      </div>
    </div>
