...
export const PricingSection: React.FC = () => {
  ...
  return (
    <section ref={ref} id="pricing" className="py-32 bg-[#0D1424] relative overflow-hidden">
      <div className="relative max-w-7xl mx-auto px-6">
        {/* Header */}
        <div
          className={`text-center mb-16 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#B9975B]/10 rounded-full border border-[#B9975B]/20 mb-6">
            <Zap className="w-4 h-4 text-[#B9975B]" />
            <span className="text-sm font-medium text-[#B9975B]">Tarifs transparents</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 max-w-5xl mx-auto gap-6 lg:gap-8">
          {/* Business Plan */}
          <div
            className={`relative rounded-3xl bg-[#1B2740] border border-[#B9975B]/20 shadow-2xl shadow-[#B9975B]/5 transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
          >
            {/* Popular badge */}
            <div className="absolute -top-4 left-1/2 -translate-x-1/2">
              <div className="flex items-center gap-1.5 px-4 py-1.5 bg-[#B9975B] rounded-full shadow-lg">
                <Star className="w-4 h-4 text-[#131C2E] fill-[#131C2E]" />
                <span className="text-sm font-medium text-[#131C2E]">Plus populaire</span>
              </div>
            </div>
            ...
            <div className="p-8">
              ...
              <div className="mb-6">
                <div className="flex items-center gap-3 mb-2">
                  <Building2 className="w-5 h-5 text-[#B9975B]/60" />
              ...
              <div className="mb-2">
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-medium text-[#B9975B]">
              ...
              <div className="mb-6 px-3 py-2 bg-white/5 rounded-xl border border-white/10">
                <p className="text-xs text-white/40">
                  ...
                  <span className="text-[#B9975B] font-medium">ADVIST = 2x moins cher</span>, concu
                  pour l'Afrique.
                </p>
              </div>

              {/* Section title */}
              <p className="text-xs font-medium text-[#B9975B]/60 uppercase tracking-wider mb-3">
              ...
              <ul className="space-y-2 mb-6">
                {[
                  ...
                  <li key={j} className="flex items-start gap-2">
                    <div className="w-4 h-4 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 bg-[#B9975B]/10">
                      <Check className="w-2.5 h-2.5 text-[#B9975B]" />
                    </div>
              ...
              <div className="mb-6 space-y-2">
                <div className="flex items-center justify-between px-3 py-2 bg-white/5 rounded-lg">
                  ...
                  <span className="text-xs font-medium text-[#B9975B]">15 000 FCFA/mois</span>
                </div>
                <div className="flex items-center justify-between px-3 py-2 bg-white/5 rounded-lg">
                  <span className="text-xs text-white/40">Pack 100 documents suppl.</span>
                  <span className="text-xs font-medium text-[#B9975B]">10 000 FCFA/mois</span>
                </div>
              </div>

              {/* CTA */}
              <a href="https://atlas-studio.org/portal?app=advist&plan=Business">
                <button className="w-full py-3.5 rounded-xl font-medium text-sm transition-all flex items-center justify-center gap-2 group bg-[#B9975B] text-[#131C2E] hover:bg-[#D4B87E]">
          ...
          {/* Entreprise Plan */}
          <div
            className={`relative rounded-3xl bg-[#1B2740] border border-white/10 hover:border-[#B9975B]/20 hover:shadow-lg transition-all duration-500 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
          >
            {/* Premium badge */}
            <div className="absolute -top-4 left-1/2 -translate-x-1/2">
              <div className="flex items-center gap-1.5 px-4 py-1.5 bg-white/10 border border-white/20 rounded-full shadow-lg">
                <Shield className="w-4 h-4 text-[#B9975B]" />
                <span className="text-sm font-medium text-[#B9975B]">Premium</span>
              </div>
            </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 bg-[#1B2740] rounded-2xl border border-white/10">
            ...
            {/* L'avantage ADVIST */}
            <div className="p-6 bg-[#B9975B]/5 rounded-2xl border border-[#B9975B]/20">
              <p className="text-sm font-medium text-[#B9975B] uppercase tracking-wider mb-4">
                L'avantage ADVIST
              </p>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start gap-2">
                    <Check className="w-4 h-4 text-[#B9975B] flex-shrink-0 mt-0.5" />
        ...
        >
          <div className="inline-flex flex-col items-center gap-3 p-6 bg-[#1B2740] rounded-2xl border border-white/10">
            <div className="flex items-center gap-2">
              <Clock className="w-5 h-5 text-[#B9975B]/60" />
