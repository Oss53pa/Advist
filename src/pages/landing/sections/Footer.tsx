          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
              <p className="text-sm text-gray-500">
                © {currentYear} <span className="font-decorative">Advist</span> by{' '}
                <a
                  href="https://atlas-studio.org"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-decorative hover:text-white transition-colors"
                >
                  Atlas Studio
                </a>
              </p>
            ...
            <div className="text-xs text-gray-600 text-center md:text-right">
              <span className="font-semibold text-gray-500">ADVIST</span>
