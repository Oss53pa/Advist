        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 mb-6 px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[#B9975B]/30 transition-all group"
            >
              <span className="font-decorative text-sm" style={{ color: '#EF9F27' }}>
                Atlas
              </span>
              <span className="text-xs text-white/50 group-hover:text-white/70">Studio</span>
              <ArrowUpRight className="w-3 h-3 text-[#B9975B]/60 group-hover:text-[#D4B87E] transition-colors" />
            </a>
