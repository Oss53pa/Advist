...
const pricingPlans: PricingPlan[] = [
  ...
  },
  {
    ...
    features: [
      'Tout illimite',
      'Signature avancee (eIDAS)',
      'Conformite OHADA',
      'API REST & SSO/SAML',
      'Support prioritaire & formation',
      'SLA 99,9%',
      'Multi-departements & RBAC',
...
const mockTenants: Tenant[] = [
  {
    ...
    monthlyPrice: 25000,
    discount: 20,
    features: ['Signature simple', '50 docs/mois', '1-5 emetteurs'],
  ...
  },
  {
    ...
    description:
      "Filiale ivoirienne du groupe Societe Generale. Leader bancaire en Afrique de l'Ouest.",
    sector: 'finance',
    companySize: '500+',
    plan: 'enterprise',
    status: 'active',
  ...
  },
  {
    ...
    notes:
      'Contrat sur mesure negocie. Inclut 5 jours de formation/an et support telephonique 24/7.',
  },
];
...
export const TenantsPage: React.FC = () => {
  ...
  const handleSaveEdit = () => {
    if (selectedTenant && editFormData) {
      setTenants(tenants.map((t) => (t.id === selectedTenant.id ? { ...t, ...editFormData } : t)));
                ...
                return (
                  <tr key={tenant.id} className="hover:bg-advist-bg/50 transition-all duration-240">
                    ...
                    <td className="px-4 py-4">
                      <div>
                        <span
                          className={`px-2.5 py-1 text-xs font-medium rounded-xl ${plan.bg} ${plan.text}`}
                        >
                          {plan.label}
                        </span>
                    ...
                    <td className="px-4 py-4">
                      <div
                        className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-xl ${status.bg}`}
                      >
                    ...
                    <td className="px-4 py-4">
                      <div>
                        <p className="text-sm text-advist-gray900 capitalize">
                          {tenant.billingCycle === 'yearly' ? 'Annuel' : 'Mensuel'}
                        </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-advist-gray900 mt-1">
                  Pour les grandes entreprises avec des besoins specifiques, contactez notre equipe
                  commerciale pour un devis personnalise incluant des fonctionnalites sur mesure, un
                  support VIP et des conditions particulieres.
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setEditFormData({ ...editFormData, companySize: e.target.value })
                        }
                        className="w-full px-4 py-2.5 border border-advist-bg rounded-xl focus:ring-2 focus:ring-advist-gold"
                      >
                        <option value="">Selectionner...</option>
                  ...
                  {editFormData.status === 'trial' && (
                    <div className="mt-4 p-3 bg-blue-50 rounded-xl">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setEditFormData({ ...editFormData, trialEndsAt: e.target.value })
                        }
                    ...
                    <div>
                      ...
                      <span className="ml-2 font-medium text-advist-gray900">
                        {editFormData.createdAt
                          ? new Date(editFormData.createdAt).toLocaleDateString('fr-FR')
                          : '-'}
                      </span>
                    </div>
                    <div>
                      ...
                      <span className="ml-2 font-medium text-advist-gray900">
                        {editFormData.lastActivity
                          ? new Date(editFormData.lastActivity).toLocaleString('fr-FR')
                          : '-'}
                      </span>
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setEditFormData({ ...editFormData, adminPhone: e.target.value })
                      }
                      placeholder="+225 XX XX XX XX XX"
                    />
                  </div>
                ...
                <div className="p-4 bg-advist-gold-light rounded-xl border border-advist-gold">
                  <div className="flex items-start gap-3">
                    <AlertTriangle
                      size={20}
                      className="text-advist-gold-dark flex-shrink-0 mt-0.5"
                    />
                    <div>
                      <h4 className="font-medium text-advist-gray900">Actions administrateur</h4>
                      <p className="text-sm text-advist-gray700 mt-1">
                        L'administrateur principal recoit les notifications importantes et peut
                        gerer tous les utilisateurs de l'organisation.
                      </p>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      >
                        ...
                        <option value="business">Business (25 000 FCFA/mois/emetteur)</option>
                        <option value="enterprise">Entreprise (150 000 FCFA/mois)</option>
                        <option value="custom">Sur mesure</option>
                      </select>
                    </div>
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setEditFormData({
                            ...editFormData,
                            billingCycle: e.target.value as Tenant['billingCycle'],
                          })
                        }
                        className="w-full px-4 py-2.5 border border-advist-bg rounded-xl focus:ring-2 focus:ring-advist-gold"
                      >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <Input
                      ...
                      onChange={(e) =>
                        setEditFormData({ ...editFormData, monthlyPrice: parseInt(e.target.value) })
                      }
                    />
                    <Input
                      ...
                      onChange={(e) =>
                        setEditFormData({ ...editFormData, discount: parseInt(e.target.value) })
                      }
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setEditFormData({ ...editFormData, nextBilling: e.target.value })
                        }
                        className="w-full px-4 py-2.5 border border-advist-bg rounded-xl focus:ring-2 focus:ring-advist-gold"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Input
                        ...
                        onChange={(e) =>
                          setEditFormData({ ...editFormData, maxUsers: parseInt(e.target.value) })
                        }
                      />
                      <div className="mt-2 h-2 bg-advist-bg rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${Math.min(((editFormData.users || 0) / (editFormData.maxUsers || 1)) * 100, 100)}%`,
                          }}
                        />
                      </div>
                      <p className="text-xs text-advist-gray500 mt-1">
                        {editFormData.users || 0} /{' '}
                        {editFormData.maxUsers === -1 ? '∞' : editFormData.maxUsers} utilises
                      </p>
                    </div>
                    <div>
                      <Input
                        ...
                        onChange={(e) =>
                          setEditFormData({ ...editFormData, maxStorage: parseInt(e.target.value) })
                        }
                      />
                      <div className="mt-2 h-2 bg-advist-bg rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${Math.min(((editFormData.storage || 0) / (editFormData.maxStorage || 1)) * 100, 100)}%`,
                          }}
                        />
                      </div>
                      <p className="text-xs text-advist-gray500 mt-1">
                        {editFormData.storage || 0} /{' '}
                        {editFormData.maxStorage === -1 ? '∞' : editFormData.maxStorage} GB utilises
                      </p>
                    </div>
                    <div>
                      <Input
                    ...
                    <div>
                      <Input
                        ...
                        onChange={(e) =>
                          setEditFormData({
                            ...editFormData,
                            maxWorkflows: parseInt(e.target.value),
                          })
                        }
                      />
                    </div>
                    <div>
                      <Input
                        ...
                        onChange={(e) =>
                          setEditFormData({
                            ...editFormData,
                            maxSignatures: parseInt(e.target.value),
                          })
                        }
                      />
                    </div>
              ...
              <div className="space-y-6">
                    ...
                    {AVAILABLE_MODULES.map((module) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div>
                            <p
                              className={`font-medium ${isEnabled ? 'text-green-900' : 'text-advist-gray900'}`}
                            >
                              {module.label}
                            </p>
                            <p
                              className={`text-sm ${isEnabled ? 'text-green-700' : 'text-advist-gray500'}`}
                            >
                              {module.description}
                            </p>
                          </div>
                ...
                <div className="p-4 bg-advist-bg rounded-xl">
                  <p className="text-sm text-advist-gray700">
                    <strong>{(editFormData.enabledModules || []).length}</strong> modules actives
                    sur <strong>{AVAILABLE_MODULES.length}</strong> disponibles
                  </p>
                </div>
              </div>
            )}
                  ...
                  <div className="space-y-4">
                    ...
                    <label className="flex items-center justify-between p-4 bg-white rounded-xl border border-advist-bg">
                      <div>
                        ...
                        <p className="text-sm text-advist-gray500">
                          Signatures electroniques legalement reconnues
                        </p>
                      </div>
                      <input
                        type="checkbox"
                        ...
                        onChange={(e) =>
                          setEditFormData({ ...editFormData, ohada: e.target.checked })
                        }
                    ...
                    <label className="flex items-center justify-between p-4 bg-white rounded-xl border border-advist-bg">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setEditFormData({ ...editFormData, twoFactorRequired: e.target.checked })
                        }
                        className="w-5 h-5 rounded text-advist-success focus:ring-advist-success"
                      />
                    </label>
                    ...
                    <div className="p-4 bg-white rounded-xl border border-advist-bg">
                      <label className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-advist-gray500">
                            Authentification unique via fournisseur externe
                          </p>
                        </div>
                        <input
                          type="checkbox"
                          ...
                          onChange={(e) =>
                            setEditFormData({ ...editFormData, ssoEnabled: e.target.checked })
                          }
                          className="w-5 h-5 rounded text-advist-success focus:ring-advist-success"
                        />
                      </label>
                      {editFormData.ssoEnabled && (
                        <div className="mt-4">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setEditFormData({ ...editFormData, ssoProvider: e.target.value })
                            }
                            className="w-full px-4 py-2.5 border border-advist-bg rounded-xl focus:ring-2 focus:ring-advist-gold"
                          >
                            <option value="">Selectionner...</option>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <label htmlFor="ohada" className="text-sm text-advist-gray900">
              {t(
                'superadmin.tenants.ohadaCompliant',
                'Conformite OHADA (signatures electroniques legales)'
              )}
            </label>
          </div>
        ...
        {selectedTenant && (
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4 p-4 bg-advist-bg rounded-xl">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <span
                    className={`px-2 py-1 text-xs font-medium rounded-xl ${getPlanBadge(selectedTenant.plan).bg} ${getPlanBadge(selectedTenant.plan).text}`}
                  >
              ...
              <div className={`px-3 py-1.5 rounded-xl ${getStatusInfo(selectedTenant.status).bg}`}>
                <span
                  className={`text-sm font-medium ${getStatusInfo(selectedTenant.status).color}`}
                >
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <div className="text-center p-4 bg-advist-bg rounded-xl">
                <p className="text-2xl font-bold text-advist-gray900">
                  {selectedTenant.documents.toLocaleString()}
                </p>
                <p className="text-sm text-advist-blue-light">Documents</p>
              </div>
              <div className="text-center p-4 bg-advist-bg rounded-xl">
                <p className="text-2xl font-bold text-advist-gray900">
                  {selectedTenant.storage} GB
                </p>
                <p className="text-sm text-advist-blue-light">Stockage</p>
              ...
              <div className="text-center p-4 bg-green-50 rounded-xl">
                <p className="text-xl font-bold text-advist-success">
                  {formatCurrency(
                    (selectedTenant.monthlyPrice * (100 - selectedTenant.discount)) / 100
                  )}
                </p>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedTenant.features.map((feature, index) => (
                    <span
                      key={index}
                      className="px-2 py-1 bg-advist-gold-light text-advist-gray900 text-xs rounded-xl"
                    >
                      {feature}
                    </span>
                  ))}
