  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-advist-gray900">Analytics Plateforme</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {platformMetrics.map((metric, index) => (
          <Card
            key={index}
            className="p-5 bg-gradient-to-br from-[#1a1a2e] to-[#2a2a4e] text-white"
          >
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            {tenantsByCountry.map((country) => (
              <div
                key={country.code}
                className="flex items-center gap-4 p-3 bg-advist-bg rounded-xl"
              >
        ...
        <Card className="p-6">
          ...
          <div className="p-4 bg-gradient-to-r from-green-50 to-primary-50 rounded-xl border border-advist-success">
            ...
            <p className="text-sm text-advist-gray900">
              La plateforme affiche une croissance de{' '}
              <span className="font-bold text-advist-success">+18.5%</span> ce mois-ci avec un taux
              d'adoption en hausse dans la region UEMOA.
            </p>
          </div>
        </Card>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-advist-bg">
                ...
                <th className="text-center py-3 px-4 text-sm font-medium text-advist-gray900">
                  Plan
                </th>
                ...
                <tr key={tenant.name} className="border-b border-advist-bg hover:bg-advist-bg">
                  ...
                  <td className="py-4 px-4 text-right">
                    <div className="flex items-center justify-end gap-1">
                      ...
                      <span className="text-sm font-medium text-advist-success">
                        +{tenant.growth}%
                      </span>
                    </div>
                  </td>
